  ...
  for (const element of blocks) {
    ...
    try {
      ...
      if (type === 'mml') {
        ...
        if (chordData) {
          // Dynamically import chord2mml ES module from CDN (pinned to main branch)
          const chord2mmlModule = await import('https://cdn.jsdelivr.net/gh/cat2151/chord2mml@main/dist/chord2mml.js');
